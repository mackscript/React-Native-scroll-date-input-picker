...
const SingelYearPicker = forwardRef((props, ref) => {
  const {
    itemHeight = 30,
    style,
    scrollViewComponent,
        ...
        {isSelected ? (
          <TextInput
            style={
              ...
              {fontWeight: 'bold', fontSize: 17, color: 'red'})
            }
  ...
  const wrapperStyle = {
    ...
    flex: 1,
    backgroundColor: wrapperBackground || '#fafafa',
    overflow: 'hidden',
  };
...
export default SingelYearPicker;
